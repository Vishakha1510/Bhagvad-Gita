...
class Chapter11 extends StatefulWidget {
  const Chapter11({super.key});

  @override
  State<Chapter11> createState() => _Chapter11State();
}

class _Chapter11State extends State<Chapter11> {
  List? chapterData;
  String? jsonString;
  ...
  Future<void> loadJson() async {
    jsonString = await rootBundle.loadString('assets/chapter11.json');
