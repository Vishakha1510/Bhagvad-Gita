...
class Chapter12 extends StatefulWidget {
  const Chapter12({super.key});

  @override
  State<Chapter12> createState() => _Chapter12State();
}

class _Chapter12State extends State<Chapter12> {
  List? chapterData;
  String? jsonString;
  ...
  Future<void> loadJson() async {
    jsonString = await rootBundle.loadString('assets/chapter12.json');
